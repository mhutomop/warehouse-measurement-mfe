                ...
                <div className="relative w-full px-4 h-full md:h-auto">
                  { 
                    this.props.form == 'edit' ?
                      <EditMeasurement item={this.props.item} closeModal={this.closeModal.bind(this)} getMeasurements={this.props.getMeasurements} />
                    : <DeleteMeasurement item={this.props.item} closeModal={this.closeModal.bind(this)} getMeasurements={this.props.getMeasurements} />
                  }
                </div>
              </div>
            </div>
